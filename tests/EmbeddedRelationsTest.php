<?php
//
//class EmbeddedRelationsTest extends BaseTestCase {
//
...
//        $address->setEventDispatcher($events);
//
...
//        $this->assertTrue(is_object($address->_id));
...
////        $user->addresses()->save(new Address(['city' => 'New-York 2']));
////        exit(dump($user->addresses->pluck('city')->all()));
//
//
//        $address->unsetEventDispatcher();
...
//        $user = User::find($user->_id);
//
//        $this->assertEquals(['London', 'New York', 'Paris'], $user->addresses->pluck('city')->all());
//        $freshUser = User::find($user->_id);
//        $this->assertEquals(['London', 'New York', 'Paris'], $freshUser->addresses->pluck('city')->all());
...
//        $this->assertEquals(['Bruges', 'Brussels', 'Ghent', 'Paris'], $user->addresses()->orderBy('city')->pluck('city')->all());
//        $this->assertEquals(['Paris', 'Ghent', 'Brussels', 'Bruges'], $user->addresses()->orderBy('city', 'desc')->pluck('city')->all());
...
//        $this->assertEquals(['Ghent', 'Brussels', 'Bruges'], $user->addresses()->where('country', 'Belgium')->orderBy('city', 'desc')->pluck('city')->all());
